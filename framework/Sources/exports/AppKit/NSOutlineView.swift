...
@objc protocol NSOutlineViewExports: JSExport, NSTableViewExports {
	// , NSAccessibilityOutlineExports
	// Static Methods
	...
	@objc var indentationPerLevel: CGFloat { get set }
...
class OutlineView: NSOutlineView, OutlineViewExports, JSOverridableView {
  ...
  override func draw(_ dirtyRect: NSRect) {
	...
	@objc class func create() -> OutlineView {
		return OutlineView()
	}
