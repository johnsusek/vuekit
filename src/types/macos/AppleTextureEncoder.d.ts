...
declare var at_block_buffer_t: at_block_buffer_t;
...
declare function at_encoder_compress_texels(encoder: NSObject, src: at_texel_region_t, dest: at_block_buffer_t, errorThreshold: number, flags: at_flags_t): number;

declare function at_encoder_create(texelType: at_texel_format_t, texelAlphaType: at_alpha_t, blockType: at_block_format_t, blockAlphaType: at_alpha_t, backgroundColor: number): NSObject;

declare function at_encoder_decompress_texels(encoder: NSObject, src: at_block_buffer_t, dest: at_texel_region_t, flags: at_flags_t): at_error_t;

declare function at_encoder_get_block_address(encoder: NSObject, texelPosition: at_size_t, imageSize: at_size_t, blockInfo: at_block_buffer_t): any;
...
declare var at_size_t: at_size_t;
...
declare var at_texel_region_t: at_texel_region_t;
