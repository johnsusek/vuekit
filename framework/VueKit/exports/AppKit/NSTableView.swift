...
@objc protocol NSTableViewExports: JSExport {
	...
	// @objc (enumerateAvailableRowViewsUsingBlock:) @available(OSX 10.7, *) func enumerateAvailableRowViews(_: JSManagedValue /* NSTableRowView, void (^ _Nonnull)(__kindof NSTableRowView * _Nonnull, NSInteger): Void */)
...
class TableView: NSTableView, NSTableViewExports, JSOverridable {
  var draw: JSValue?
  ...
  override func draw(_ dirtyRect: NSRect) {
	...
	@objc override class func create() -> TableView {
		return TableView()
	}
}
