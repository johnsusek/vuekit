...
@objc protocol NSMenuExports: JSExport {
	...
	@objc (itemArray) var items: [NSMenuItem] { @objc (itemArray) get @objc (setItemArray:) set }
	@objc var menuBarHeight: CGFloat { get }
	@objc @available(OSX 10.6, *) var minimumWidth: CGFloat { get set }
