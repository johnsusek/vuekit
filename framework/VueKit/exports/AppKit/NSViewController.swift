...
@objc protocol NSViewControllerExports: JSExport {
	...
	// @objc (transitionFromViewController:toViewController:options:completionHandler:) @available(OSX 10.10, *) func transition(from: NSViewController, to: NSViewController, options: NSViewController.TransitionOptions, completionHandler: JSManagedValue /* : Void */?)
...
extension NSViewController: NSViewControllerExports {
	...
	@objc override class func create() -> NSViewController {
