...
@objc protocol NSViewExports: JSExport, NSResponderExports {
	// , NSAccessibilityExports, NSAccessibilityElementExports, NSAnimatablePropertyContainerExports, NSAppearanceCustomizationExports, NSDraggingDestinationExports, NSUserInterfaceItemIdentificationExports
	// Static Methods
	...
	@objc (focusView) static var focusView: NSView? { @objc get }
	...
	@objc func adjustPageHeightNew(_ newBottom: UnsafeMutablePointer<CGFloat>, top oldTop: CGFloat, bottom oldBottom: CGFloat, limit bottomLimit: CGFloat)
	@objc func adjustPageWidthNew(_ newRight: UnsafeMutablePointer<CGFloat>, left oldLeft: CGFloat, right oldRight: CGFloat, limit rightLimit: CGFloat)
	...
	@objc func endPage()
	@objc @available(OSX 10.5, *) func enterFullScreenMode(_ screen: NSScreen, withOptions options: [NSView.FullScreenModeOptionKey : Any]?) -> Bool
	...
	@objc func getRectsBeingDrawn(_ rects: UnsafeMutablePointer<UnsafePointer<NSRect>?>?, count: UnsafeMutablePointer<Int>?)
	...
	@objc (registerForDraggedTypes:) func registerForDraggedTypes(_ newTypes: [NSPasteboard.PasteboardType])
	...
	@objc (rotateByAngle:) func rotate(byDegrees angle: CGFloat)
	...
	@objc @available(OSX 10.7, *) func rulerView(_ ruler: NSRulerView, pointForLocation point: CGFloat) -> NSPoint
	...
	@objc (rulerView:willAddMarker:atLocation:) func rulerView(_ ruler: NSRulerView, willAdd marker: NSRulerMarker, atLocation location: CGFloat) -> CGFloat
	@objc (rulerView:willMoveMarker:toLocation:) func rulerView(_ ruler: NSRulerView, willMove marker: NSRulerMarker, toLocation location: CGFloat) -> CGFloat
	...
	// jsvalue - @objc (showDefinitionForAttributedString:range:options:baselineOriginProvider:) @available(OSX 10.6, *) func showDefinition(`for`: NSAttributedString?, range: NSRange, options: [String: Any]?, baselineOriginProvider: JSValue)
	...
	@objc @available(OSX 10.5, *) var alphaValue: CGFloat { get set }
	...
	@objc @available(OSX 10.11, *) var firstBaselineOffsetFromTop: CGFloat { get }
	...
	@objc @available(OSX 10.5, *) var frameCenterRotation: CGFloat { get set }
	@objc var frameRotation: CGFloat { get set }
	...
	@objc var heightAdjustLimit: CGFloat { get }
	...
	@objc @available(OSX 10.11, *) var lastBaselineOffsetFromBottom: CGFloat { get }
	...
	@objc (nextKeyView) var nextKeyView: NSView? { @objc get @objc (setNextKeyView:) set }
	@objc (nextValidKeyView) var nextValidKeyView: NSView? { @objc get }
	...
	@objc (previousKeyView) var previousKeyView: NSView? { @objc get }
	@objc (previousValidKeyView) var previousValidKeyView: NSView? { @objc get }
	@objc var printJobTitle: String { @objc get }
	@objc var rectPreservedDuringLiveResize: NSRect { @objc get }
	@objc var registeredDraggedTypes: [NSPasteboard.PasteboardType] { get }
	...
	@objc var widthAdjustLimit: CGFloat { get }
