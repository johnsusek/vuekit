...
@objc protocol NSWindowExports: JSExport, NSResponderExports {
	// , NSAccessibilityExports, NSAccessibilityElementExports, NSAnimatablePropertyContainerExports, NSAppearanceCustomizationExports, NSMenuItemValidationExports, NSUserInterfaceItemIdentificationExports, NSUserInterfaceValidationsExports
	// Static Methods
	...
	@objc (setContentBorderThickness:forEdge:) @available(OSX 10.5, *) func setContentBorderThickness(_ thickness: CGFloat, for edge: NSRectEdge)
	...
	@objc var alphaValue: CGFloat { get set }
	...
	@objc (canBecomeKeyWindow) var canBecomeKey: Bool { @objc (canBecomeKeyWindow) get }
	@objc (canBecomeMainWindow) var canBecomeMain: Bool { @objc (canBecomeMainWindow) get }
	...
	@objc (parentWindow) var parent: NSWindow? { @objc (parentWindow) get @objc (setParentWindow:) set }
	...
	@objc @available(OSX 10.5, *) var representedURL: URL? { get set }
	...
	@objc (stringWithSavedFrame) var frameDescriptor: NSWindow.PersistableFrameDescriptor { @objc (stringWithSavedFrame) get }
	...
	// Constructors
	@objc static func create(contentRect: NSRect, styleMask: NSWindow.StyleMask, backing: NSWindow.BackingStoreType, `defer`: Bool) -> NSWindow
	@objc static func create(contentRect: NSRect, styleMask: NSWindow.StyleMask, backing: NSWindow.BackingStoreType, `defer`: Bool, screen: NSScreen?) -> NSWindow
	@objc static func create(windowRef: UnsafeMutableRawPointer) -> NSWindow?
}

extension NSWindow: NSWindowExports {
	@objc class func create(contentRect: NSRect, styleMask: NSWindow.StyleMask, backing: NSWindow.BackingStoreType, `defer`: Bool) -> NSWindow {
		return NSWindow(contentRect: contentRect, styleMask: styleMask, backing: backing, `defer`: `defer`)
	}

	@objc class func create(contentRect: NSRect, styleMask: NSWindow.StyleMask, backing: NSWindow.BackingStoreType, `defer`: Bool, screen: NSScreen?) -> NSWindow {
		return NSWindow(contentRect: contentRect, styleMask: styleMask, backing: backing, `defer`: `defer`, screen: screen)
	}

	@objc class func create(windowRef: UnsafeMutableRawPointer) -> NSWindow? {
		return NSWindow(windowRef: windowRef)
	}
