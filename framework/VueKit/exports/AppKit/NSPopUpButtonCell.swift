...
@objc protocol NSPopUpButtonCellExports: JSExport {
	...
	@objc static func initTextCell(textCell: String, pullsDown: Bool) -> NSPopUpButtonCell
}

extension NSPopUpButtonCell: NSPopUpButtonCellExports {
	@objc class func initTextCell(textCell: String, pullsDown: Bool) -> NSPopUpButtonCell {
