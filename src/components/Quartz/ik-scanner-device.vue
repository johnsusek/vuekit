  ...
  computed: {
    attrs() {
      ...
      if (this.mode !== undefined) {
        attrs.mode = IKScannerDeviceViewDisplayMode[this.mode];
      }

      if (this["transfer-mode"] !== undefined) {
        attrs["transfer-mode"] =
          IKScannerDeviceViewTransferMode[this["transfer-mode"]];
      }
