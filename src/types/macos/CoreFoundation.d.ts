...
declare function CFBundleLoadExecutableAndReturnError(bundle: any, error: NSError): boolean;

declare function CFBundlePreflightExecutable(bundle: any, error: NSError): boolean;
...
globalThis.CFCalendarUnit = CFCalendarUnit;
...
globalThis.CFCharacterSetPredefinedSet = CFCharacterSetPredefinedSet;
...
globalThis.CFComparisonResult = CFComparisonResult;

declare function CFCopyDescription(cf: any): string;

declare function CFCopyTypeIDDescription(type_id: number): string;

declare function CFDataAppendBytes(theData: NSData, bytes: string | any, length: number): void;

declare function CFDataCreate(allocator: any, bytes: string | any, length: number): NSData;
...
declare function CFDataCreateWithBytesNoCopy(allocator: any, bytes: string | any, length: number, bytesDeallocator: any): NSData;
...
declare function CFDataGetBytes(theData: NSData, range: CFRange, buffer: string | any): void;
...
declare function CFDataReplaceBytes(theData: NSData, range: CFRange, newBytes: string | any, newLength: number): void;
...
globalThis.CFDataSearchFlags = CFDataSearchFlags;
...
globalThis.CFDateFormatterStyle = CFDateFormatterStyle;
...
declare function CFErrorCreateWithUserInfoKeysAndValues(allocator: any, domain: any, code: number, userInfoKeys: any, userInfoValues: any, numUserInfoValues: number): NSError;
...
globalThis.CFFileSecurityClearOptions = CFFileSecurityClearOptions;
...
globalThis.CFGregorianUnitFlags = CFGregorianUnitFlags;
...
globalThis.CFISO8601DateFormatOptions = CFISO8601DateFormatOptions;
...
globalThis.CFLocaleLanguageDirection = CFLocaleLanguageDirection;
...
declare function CFMessagePortCreateLocal(allocator: any, name: string, callout: (p1: NSMessagePort, p2: number, p3: NSData, p4: any) => NSData, context: CFMessagePortContext, shouldFreeInfo: string | any): NSMessagePort;
...
declare function CFMessagePortGetContext(ms: NSMessagePort, context: CFMessagePortContext): void;

declare function CFMessagePortGetInvalidationCallBack(ms: NSMessagePort): (p1: NSMessagePort, p2: any) => void;
...
declare function CFMessagePortSendRequest(remote: NSMessagePort, msgid: number, data: NSData, sendTimeout: number, rcvTimeout: number, replyMode: string, returnData: NSData): number;

declare function CFMessagePortSetDispatchQueue(ms: NSMessagePort, queue: NSObject): void;

declare function CFMessagePortSetInvalidationCallBack(ms: NSMessagePort, callout: (p1: NSMessagePort, p2: any) => void): void;
...
globalThis.CFNotificationSuspensionBehavior = CFNotificationSuspensionBehavior;
...
globalThis.CFNumberFormatterOptionFlags = CFNumberFormatterOptionFlags;
...
globalThis.CFNumberFormatterPadPosition = CFNumberFormatterPadPosition;
...
globalThis.CFNumberFormatterRoundingMode = CFNumberFormatterRoundingMode;
...
globalThis.CFNumberFormatterStyle = CFNumberFormatterStyle;
...
globalThis.CFNumberType = CFNumberType;
...
declare function CFPropertyListCreateData(allocator: any, propertyList: any, format: CFPropertyListFormat, options: number, error: NSError): NSData;

declare function CFPropertyListCreateDeepCopy(allocator: any, propertyList: any, mutabilityOption: number): any;

declare function CFPropertyListCreateWithData(allocator: any, data: NSData, options: number, format: CFPropertyListFormat, error: NSError): any;

declare function CFPropertyListCreateWithStream(allocator: any, stream: NSInputStream, streamLength: number, options: number, format: CFPropertyListFormat, error: NSError): any;
...
globalThis.CFPropertyListFormat = CFPropertyListFormat;
...
globalThis.CFPropertyListMutabilityOptions = CFPropertyListMutabilityOptions;

declare function CFPropertyListWrite(propertyList: any, stream: NSOutputStream, format: CFPropertyListFormat, options: number, error: NSError): number;
...
declare function CFReadStreamCreateWithBytesNoCopy(alloc: any, bytes: string | any, length: number, bytesDeallocator: any): NSInputStream;

declare function CFReadStreamCreateWithFile(alloc: any, fileURL: NSURL): NSInputStream;

declare function CFReadStreamGetBuffer(stream: NSInputStream, maxBytesToRead: number, numBytesRead: number): string;
...
declare function CFReadStreamRead(stream: NSInputStream, buffer: string | any, bufferLength: number): number;

declare function CFReadStreamScheduleWithRunLoop(stream: NSInputStream, runLoop: any, runLoopMode: any): void;

declare function CFReadStreamSetClient(stream: NSInputStream, streamEvents: number, clientCB: (p1: NSInputStream, p2: CFStreamEventType, p3: any) => void, clientContext: CFStreamClientContext): boolean;
...
globalThis.CFRunLoopActivity = CFRunLoopActivity;
...
globalThis.CFRunLoopRunResult = CFRunLoopRunResult;
...
declare function CFRunLoopTimerCreate(allocator: any, fireDate: number, interval: number, flags: number, order: number, callout: (p1: NSTimer, p2: any) => void, context: CFRunLoopTimerContext): NSTimer;
...
declare function CFRunLoopTimerGetContext(timer: NSTimer, context: CFRunLoopTimerContext): void;
...
declare function CFSetAddValue(theSet: NSSet<any>, value: any): void;

declare function CFSetApplyFunction(theSet: NSSet<any>, applier: (p1: any, p2: any) => void, context: any): void;
...
declare function CFSetContainsValue(theSet: NSSet<any>, value: any): boolean;

declare function CFSetCreate(allocator: any, values: any, numValues: number, callBacks: CFSetCallBacks): NSSet<any>;

declare function CFSetCreateCopy(allocator: any, theSet: NSSet<any>): NSSet<any>;

declare function CFSetCreateMutable(allocator: any, capacity: number, callBacks: CFSetCallBacks): NSSet<any>;
...
declare function CFSetGetCountOfValue(theSet: NSSet<any>, value: any): number;

declare function CFSetGetTypeID(): number;

declare function CFSetGetValue(theSet: NSSet<any>, value: any): any;

declare function CFSetGetValueIfPresent(theSet: NSSet<any>, candidate: any, value: any): boolean;

declare function CFSetGetValues(theSet: NSSet<any>, values: any): void;

declare function CFSetRemoveAllValues(theSet: NSSet<any>): void;

declare function CFSetRemoveValue(theSet: NSSet<any>, value: any): void;

declare function CFSetReplaceValue(theSet: NSSet<any>, value: any): void;

declare function CFSetSetValue(theSet: NSSet<any>, value: any): void;
...
globalThis.CFSocketCallBackType = CFSocketCallBackType;
...
declare function CFSocketCopyRegisteredSocketSignature(nameServerSignature: CFSocketSignature, timeout: number, name: string, signature: CFSocketSignature, nameServerAddress: NSData): CFSocketError;

declare function CFSocketCopyRegisteredValue(nameServerSignature: CFSocketSignature, timeout: number, name: string, value: any, nameServerAddress: NSData): CFSocketError;

declare function CFSocketCreate(allocator: any, protocolFamily: number, socketType: number, protocol: number, callBackTypes: number, callout: (p1: any, p2: CFSocketCallBackType, p3: NSData, p4: any, p5: any) => void, context: CFSocketContext): any;

declare function CFSocketCreateConnectedToSocketSignature(allocator: any, signature: CFSocketSignature, callBackTypes: number, callout: (p1: any, p2: CFSocketCallBackType, p3: NSData, p4: any, p5: any) => void, context: CFSocketContext, timeout: number): any;

declare function CFSocketCreateRunLoopSource(allocator: any, s: any, order: number): any;

declare function CFSocketCreateWithNative(allocator: any, sock: number, callBackTypes: number, callout: (p1: any, p2: CFSocketCallBackType, p3: NSData, p4: any, p5: any) => void, context: CFSocketContext): any;

declare function CFSocketCreateWithSocketSignature(allocator: any, signature: CFSocketSignature, callBackTypes: number, callout: (p1: any, p2: CFSocketCallBackType, p3: NSData, p4: any, p5: any) => void, context: CFSocketContext): any;
...
globalThis.CFSocketError = CFSocketError;
...
declare function CFStreamCreateBoundPair(alloc: any, readStream: NSInputStream, writeStream: NSOutputStream, transferBufferSize: number): void;

declare function CFStreamCreatePairWithPeerSocketSignature(alloc: any, signature: CFSocketSignature, readStream: NSInputStream, writeStream: NSOutputStream): void;

declare function CFStreamCreatePairWithSocket(alloc: any, sock: number, readStream: NSInputStream, writeStream: NSOutputStream): void;

declare function CFStreamCreatePairWithSocketToHost(alloc: any, host: string, port: number, readStream: NSInputStream, writeStream: NSOutputStream): void;
...
globalThis.CFStreamErrorDomain = CFStreamErrorDomain;
...
globalThis.CFStreamEventType = CFStreamEventType;
...
globalThis.CFStreamStatus = CFStreamStatus;
...
globalThis.CFStringBuiltInEncodings = CFStringBuiltInEncodings;
...
globalThis.CFStringCompareFlags = CFStringCompareFlags;
...
globalThis.CFStringEncodings = CFStringEncodings;
...
declare function CFStringFindCharacterFromSet(theString: string, theSet: NSCharacterSet, rangeToSearch: CFRange, searchOptions: CFStringCompareFlags, result: CFRange): boolean;
...
declare function CFStringFindWithOptionsAndLocale(theString: string, stringToFind: string, rangeToSearch: CFRange, searchOptions: CFStringCompareFlags, locale: NSLocale, result: CFRange): boolean;
...
declare function CFStringGetHyphenationLocationBeforeIndex(string: string, location: number, limitRange: CFRange, options: number, locale: NSLocale, character: number): number;
...
globalThis.CFStringNormalizationForm = CFStringNormalizationForm;
...
globalThis.CFStringTokenizerTokenType = CFStringTokenizerTokenType;
...
globalThis.CFTimeZoneNameStyle = CFTimeZoneNameStyle;
...
globalThis.CFURLBookmarkCreationOptions = CFURLBookmarkCreationOptions;
...
globalThis.CFURLBookmarkResolutionOptions = CFURLBookmarkResolutionOptions;
...
globalThis.CFURLComponentType = CFURLComponentType;
...
declare function CFURLCopyResourcePropertiesForKeys(url: NSURL, keys: NSArray<any> | any[], error: NSError): NSDictionary<any, any>;

declare function CFURLCopyResourcePropertyForKey(url: NSURL, key: string, propertyValueTypeRefPtr: any, error: NSError): boolean;
...
declare function CFURLCreateBookmarkData(allocator: any, url: NSURL, options: CFURLBookmarkCreationOptions, resourcePropertiesToInclude: NSArray<any> | any[], relativeToURL: NSURL, error: NSError): NSData;

declare function CFURLCreateBookmarkDataFromAliasRecord(allocatorRef: any, aliasRecordDataRef: NSData): NSData;

declare function CFURLCreateBookmarkDataFromFile(allocator: any, fileURL: NSURL, errorRef: NSError): NSData;

declare function CFURLCreateByResolvingBookmarkData(allocator: any, bookmark: NSData, options: CFURLBookmarkResolutionOptions, relativeToURL: NSURL, resourcePropertiesToInclude: NSArray<any> | any[], isStale: string | any, error: NSError): NSURL;
...
declare function CFURLCreateFilePathURL(allocator: any, url: NSURL, error: NSError): NSURL;

declare function CFURLCreateFileReferenceURL(allocator: any, url: NSURL, error: NSError): NSURL;
...
declare function CFURLCreateResourcePropertiesForKeysFromBookmarkData(allocator: any, resourcePropertiesToReturn: NSArray<any> | any[], bookmark: NSData): NSDictionary<any, any>;
...
declare function CFURLEnumeratorGetNextURL(enumerator: any, url: NSURL, error: NSError): CFURLEnumeratorResult;
...
globalThis.CFURLEnumeratorOptions = CFURLEnumeratorOptions;
...
globalThis.CFURLEnumeratorResult = CFURLEnumeratorResult;
...
globalThis.CFURLPathStyle = CFURLPathStyle;

declare function CFURLResourceIsReachable(url: NSURL, error: NSError): boolean;

declare function CFURLSetResourcePropertiesForKeys(url: NSURL, keyedPropertyValues: NSDictionary<any, any>, error: NSError): boolean;

declare function CFURLSetResourcePropertyForKey(url: NSURL, key: string, propertyValue: any, error: NSError): boolean;
...
declare function CFURLWriteBookmarkDataToFile(bookmarkRef: NSData, fileURL: NSURL, options: number, errorRef: NSError): boolean;
...
declare function CFWriteStreamCreateWithBuffer(alloc: any, buffer: string | any, bufferCapacity: number): NSOutputStream;
...
declare function CFWriteStreamSetClient(stream: NSOutputStream, streamEvents: number, clientCB: (p1: NSOutputStream, p2: CFStreamEventType, p3: any) => void, clientContext: CFStreamClientContext): boolean;
...
declare function CFWriteStreamWrite(stream: NSOutputStream, buffer: string | any, bufferLength: number): number;
...
globalThis.CFXMLEntityTypeCode = CFXMLEntityTypeCode;
...
globalThis.CFXMLNodeTypeCode = CFXMLNodeTypeCode;
...
globalThis.CFXMLParserOptions = CFXMLParserOptions;
...
globalThis.CFXMLParserStatusCode = CFXMLParserStatusCode;
...
globalThis.__CFByteOrder = __CFByteOrder;
