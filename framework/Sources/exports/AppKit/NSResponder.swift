...
@objc protocol NSResponderExports: JSExport {
	// , NSCodingExports, NSStandardKeyBindingRespondingExports, NSUserActivityRestoringExports, NSTouchBarProviderExports
	// Static Methods
	...
	@objc (nextResponder) var nextResponder: NSResponder? { @objc get @objc (setNextResponder:) set }
