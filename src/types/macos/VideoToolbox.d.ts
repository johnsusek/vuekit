...
declare function VTCompressionSessionBeginPass(session: any, beginPassFlags: VTCompressionSessionOptionFlags, reserved: number): number;

declare function VTCompressionSessionCompleteFrames(session: any, completeUntilPresentationTimeStamp: CMTime): number;

declare function VTCompressionSessionCreate(allocator: any, width: number, height: number, codecType: number, encoderSpecification: NSDictionary<any, any>, sourceImageBufferAttributes: NSDictionary<any, any>, compressedDataAllocator: any, outputCallback: (p1: any, p2: any, p3: number, p4: VTEncodeInfoFlags, p5: any) => void, outputCallbackRefCon: any, compressionSessionOut: any): number;

declare function VTCompressionSessionEncodeFrame(session: any, imageBuffer: any, presentationTimeStamp: CMTime, duration: CMTime, frameProperties: NSDictionary<any, any>, sourceFrameRefcon: any, infoFlagsOut: VTEncodeInfoFlags): number;

declare function VTCompressionSessionEncodeFrameWithOutputHandler(session: any, imageBuffer: any, presentationTimeStamp: CMTime, duration: CMTime, frameProperties: NSDictionary<any, any>, infoFlagsOut: VTEncodeInfoFlags, outputHandler: (p1: number, p2: VTEncodeInfoFlags, p3: any) => void): number;

declare function VTCompressionSessionEndPass(session: any, furtherPassesRequestedOut: string | any, reserved: number): number;

declare function VTCompressionSessionGetPixelBufferPool(session: any): any;

declare function VTCompressionSessionGetTimeRangesForNextPass(session: any, timeRangeCountOut: number, timeRangeArrayOut: CMTimeRange): number;

declare function VTCompressionSessionGetTypeID(): number;

declare function VTCompressionSessionInvalidate(session: any): void;

enum VTCompressionSessionOptionFlags {
...
declare function VTCopySupportedPropertyDictionaryForEncoder(width: number, height: number, codecType: number, encoderSpecification: NSDictionary<any, any>, encoderIDOut: string, supportedPropertiesOut: NSDictionary<any, any>): number;

declare function VTCopyVideoEncoderList(options: NSDictionary<any, any>, listOfVideoEncodersOut: NSArray<any>): number;

declare function VTCreateCGImageFromCVPixelBuffer(pixelBuffer: any, options: NSDictionary<any, any>, imageOut: any): number;
...
interface VTDecompressionOutputCallbackRecord {
	decompressionOutputCallback: (p1: any, p2: any, p3: number, p4: VTDecodeInfoFlags, p5: any, p6: CMTime, p7: CMTime) => void;
	decompressionOutputRefCon: any;
}
declare var VTDecompressionOutputCallbackRecord: VTDecompressionOutputCallbackRecord;
...
declare function VTDecompressionSessionCreate(allocator: any, videoFormatDescription: any, videoDecoderSpecification: NSDictionary<any, any>, destinationImageBufferAttributes: NSDictionary<any, any>, outputCallback: VTDecompressionOutputCallbackRecord, decompressionSessionOut: any): number;

declare function VTDecompressionSessionDecodeFrame(session: any, sampleBuffer: any, decodeFlags: VTDecodeFrameFlags, sourceFrameRefCon: any, infoFlagsOut: VTDecodeInfoFlags): number;

declare function VTDecompressionSessionDecodeFrameWithOutputHandler(session: any, sampleBuffer: any, decodeFlags: VTDecodeFrameFlags, infoFlagsOut: VTDecodeInfoFlags, outputHandler: (p1: number, p2: VTDecodeInfoFlags, p3: any, p4: CMTime, p5: CMTime) => void): number;
...
declare function VTFrameSiloCallFunctionForEachSampleBuffer(silo: any, timeRange: CMTimeRange, refcon: any, callback: (p1: any, p2: any) => number): number;

declare function VTFrameSiloCreate(allocator: any, fileURL: NSURL, timeRange: CMTimeRange, options: NSDictionary<any, any>, frameSiloOut: any): number;

declare function VTFrameSiloGetProgressOfCurrentPass(silo: any, progressOut: number): number;

declare function VTFrameSiloGetTypeID(): number;

declare function VTFrameSiloSetTimeRangesForNextPass(silo: any, timeRangeCount: number, timeRangeArray: CMTimeRange): number;

interface VTInt32Point {
	x: number;
	y: number;
}
declare var VTInt32Point: VTInt32Point;

interface VTInt32Size {
	width: number;
	height: number;
}
declare var VTInt32Size: VTInt32Size;
...
declare function VTMultiPassStorageCreate(allocator: any, fileURL: NSURL, timeRange: CMTimeRange, options: NSDictionary<any, any>, multiPassStorageOut: any): number;

declare function VTMultiPassStorageGetTypeID(): number;

declare function VTPixelTransferSessionCreate(allocator: any, pixelTransferSessionOut: any): number;
...
declare function VTSessionCopySerializableProperties(session: any, allocator: any, dictionaryOut: NSDictionary<any, any>): number;

declare function VTSessionCopySupportedPropertyDictionary(session: any, supportedPropertyDictionaryOut: NSDictionary<any, any>): number;
