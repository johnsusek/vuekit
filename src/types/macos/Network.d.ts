...
declare function nw_advertise_descriptor_create_bonjour_service(name: string | any, type: string | any, domain: string | any): NSObject;
...
declare function nw_advertise_descriptor_set_txt_record(advertise_descriptor: NSObject, txt_record: any, txt_length: number): void;

declare function nw_advertise_descriptor_set_txt_record_object(advertise_descriptor: NSObject, txt_record: NSObject): void;

declare function nw_browse_descriptor_create_bonjour_service(type: string | any, domain: string | any): NSObject;
...
declare function nw_browser_create(descriptor: NSObject, p2: NSObject): NSObject;
...
declare function nw_connection_create(endpoint: NSObject, p2: NSObject): NSObject;
...
declare function nw_content_context_create(context_identifier: string | any): NSObject;
...
enum nw_data_transfer_report_state_t {
...
declare function nw_endpoint_create_address(address: sockaddr): NSObject;

declare function nw_endpoint_create_bonjour_service(name: string | any, type: string | any, domain: string | any): NSObject;

declare function nw_endpoint_create_host(hostname: string | any, port: string | any): NSObject;

declare function nw_endpoint_create_url(url: string | any): NSObject;

declare function nw_endpoint_get_address(endpoint: NSObject): sockaddr;
...
declare function nw_error_copy_cf_error(error: NSObject): NSError;

enum nw_error_domain_t {
...
declare function nw_ethernet_channel_send(ethernet_channel: NSObject, content: NSObject, vlan_tag: number, remote_address: number, completion: (p1: NSObject) => void): void;

declare function nw_ethernet_channel_set_queue(ethernet_channel: NSObject, queue: NSObject): void;

declare function nw_ethernet_channel_set_receive_handler(ethernet_channel: NSObject, handler: (p1: NSObject, p2: number, p3: number, p4: number) => void): void;

declare function nw_ethernet_channel_set_state_changed_handler(ethernet_channel: NSObject, handler: (p1: nw_ethernet_channel_state_t, p2: NSObject) => void): void;

declare function nw_ethernet_channel_start(ethernet_channel: NSObject): void;

enum nw_ethernet_channel_state_t {
...
declare function nw_framer_create_definition(identifier: string | any, flags: number, start_handler: (p1: NSObject) => nw_framer_start_result_t): NSObject;

declare function nw_framer_create_options(framer_definition: NSObject): NSObject;

declare function nw_framer_deliver_input(framer: NSObject, input_buffer: string | any, input_length: number, message: NSObject, is_complete: boolean): void;
...
declare function nw_framer_message_access_value(message: NSObject, key: string | any, access_value: (p1: any) => boolean): boolean;

declare function nw_framer_message_copy_object_value(message: NSObject, key: string | any): any;

declare function nw_framer_message_create(framer: NSObject): NSObject;

declare function nw_framer_message_set_object_value(message: NSObject, key: string | any, value: any): void;

declare function nw_framer_message_set_value(message: NSObject, key: string | any, value: any, dispose_value: (p1: any) => void): void;

declare function nw_framer_parse_input(framer: NSObject, minimum_incomplete_length: number, maximum_length: number, temp_buffer: string | any, parse: (p1: string, p2: number, p3: boolean) => number): boolean;

declare function nw_framer_parse_output(framer: NSObject, minimum_incomplete_length: number, maximum_length: number, temp_buffer: string | any, parse: (p1: string, p2: number, p3: boolean) => number): boolean;
...
declare function nw_framer_write_output(framer: NSObject, output_buffer: string | any, output_length: number): void;
...
enum nw_ip_local_address_preference_t {
...
declare function nw_listener_create(p1: NSObject): NSObject;

declare function nw_listener_create_with_connection(connection: NSObject, p2: NSObject): NSObject;

declare function nw_listener_create_with_port(port: string | any, p2: NSObject): NSObject;
...
declare function nw_parameters_clear_prohibited_interface_types(p1: NSObject): void;

declare function nw_parameters_clear_prohibited_interfaces(p1: NSObject): void;

declare function nw_parameters_copy(p1: NSObject): NSObject;

declare function nw_parameters_copy_default_protocol_stack(p1: NSObject): NSObject;

declare function nw_parameters_copy_local_endpoint(p1: NSObject): NSObject;

declare function nw_parameters_copy_required_interface(p1: NSObject): NSObject;
...
enum nw_parameters_expired_dns_behavior_t {
...
declare function nw_parameters_get_expired_dns_behavior(p1: NSObject): nw_parameters_expired_dns_behavior_t;

declare function nw_parameters_get_fast_open_enabled(p1: NSObject): boolean;

declare function nw_parameters_get_include_peer_to_peer(p1: NSObject): boolean;

declare function nw_parameters_get_local_only(p1: NSObject): boolean;

declare function nw_parameters_get_multipath_service(p1: NSObject): nw_multipath_service_t;

declare function nw_parameters_get_prefer_no_proxy(p1: NSObject): boolean;

declare function nw_parameters_get_prohibit_constrained(p1: NSObject): boolean;

declare function nw_parameters_get_prohibit_expensive(p1: NSObject): boolean;

declare function nw_parameters_get_required_interface_type(p1: NSObject): nw_interface_type_t;

declare function nw_parameters_get_reuse_local_address(p1: NSObject): boolean;

declare function nw_parameters_get_service_class(p1: NSObject): nw_service_class_t;

declare function nw_parameters_iterate_prohibited_interface_types(p1: NSObject): void;

declare function nw_parameters_iterate_prohibited_interfaces(p1: NSObject): void;

declare function nw_parameters_prohibit_interface(p1: NSObject): void;

declare function nw_parameters_prohibit_interface_type(p1: NSObject): void;

declare function nw_parameters_require_interface(p1: NSObject): void;

declare function nw_parameters_set_expired_dns_behavior(p1: NSObject): void;

declare function nw_parameters_set_fast_open_enabled(p1: NSObject): void;

declare function nw_parameters_set_include_peer_to_peer(p1: NSObject): void;

declare function nw_parameters_set_local_endpoint(p1: NSObject): void;

declare function nw_parameters_set_local_only(p1: NSObject): void;

declare function nw_parameters_set_multipath_service(p1: NSObject): void;

declare function nw_parameters_set_prefer_no_proxy(p1: NSObject): void;

declare function nw_parameters_set_prohibit_constrained(p1: NSObject): void;

declare function nw_parameters_set_prohibit_expensive(p1: NSObject): void;

declare function nw_parameters_set_required_interface_type(p1: NSObject): void;

declare function nw_parameters_set_reuse_local_address(p1: NSObject): void;

declare function nw_parameters_set_service_class(p1: NSObject): void;
...
declare function nw_release(obj: any): void;

enum nw_report_resolution_source_t {
...
declare function nw_retain(obj: any): any;

enum nw_service_class_t {
...
declare function nw_txt_record_access_key(txt_record: NSObject, key: string | any, access_value: (p1: string, p2: nw_txt_record_find_key_t, p3: string, p4: number) => boolean): boolean;
...
declare function nw_txt_record_create_with_bytes(txt_bytes: string | any, txt_len: number): NSObject;

declare function nw_txt_record_find_key(txt_record: NSObject, key: string | any): nw_txt_record_find_key_t;

enum nw_txt_record_find_key_t {
...
declare function nw_txt_record_remove_key(txt_record: NSObject, key: string | any): boolean;

declare function nw_txt_record_set_key(txt_record: NSObject, key: string | any, value: string | any, value_len: number): boolean;
...
declare function nw_ws_options_add_additional_header(options: NSObject, name: string | any, value: string | any): void;

declare function nw_ws_options_add_subprotocol(options: NSObject, subprotocol: string | any): void;
...
declare function nw_ws_response_add_additional_header(response: NSObject, name: string | any, value: string | any): void;

declare function nw_ws_response_create(status: nw_ws_response_status_t, selected_subprotocol: string | any): NSObject;
