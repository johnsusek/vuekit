...
declare function dispatch_introspection_hook_queue_callout_begin(queue: NSObject, context: any, function_: (p1: any) => void): void;

declare function dispatch_introspection_hook_queue_callout_end(queue: NSObject, context: any, function_: (p1: any) => void): void;
